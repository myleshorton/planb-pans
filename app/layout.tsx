        ...
        >
          ...
          >
            ...
            <nav style={{ display: 'flex', gap: 18, alignItems: 'center' }}>
              ...
              <a href="/deconstructing-pans.html" style={{ fontFamily: 'var(--font-inter)', fontSize: 13, color: 'var(--teal)', fontWeight: 700, textDecoration: 'none', whiteSpace: 'nowrap' }}>Deconstructing PANS</a>
