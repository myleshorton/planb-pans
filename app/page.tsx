            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px' }}>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  A parent's journey through Plans A, B, and C. Hope, challenges, and breakthroughs.
                </p>
                <p style={{
                  fontFamily: 'var(--font-inter), sans-serif',
                  fontSize: '12px',
                  ...
                  Plans: A → B → C • Progress: Documented
                </p>
              </div>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  Physicians sharing what's working. Alternative modalities. Integrated approaches.
                </p>
                <p style={{
                  fontFamily: 'var(--font-inter), sans-serif',
                  fontSize: '12px',
                  ...
                  Focus: Multi-modal Care • Results: Evolving
                </p>
              </div>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  When nothing worked, they found their way. Real progress. Real hope.
                </p>
                <p style={{
                  fontFamily: 'var(--font-inter), sans-serif',
                  fontSize: '12px',
