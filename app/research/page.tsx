        ...
        <div className="pb-container" style={{ maxWidth: 920 }}>
          ...
          <div style={{ display: 'grid', gap: 14 }}>
            {[
              ...
              { tag: 'New · IVIG access', title: 'The Unhide™ Project — economic impact of IVIG on PANS/PANDAS families', why: 'Documents the financial reality of pursuing IVIG — the evidence base for the insurance-coverage fight.', nct: 'NCT06818656', href: 'https://clinicaltrials.gov/study/NCT06818656' },
